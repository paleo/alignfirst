...
export function printWorkspaceHelp(): void {
  console.log(
    [
      ...
      "      Finalize runs detached in the background; this command blocks until it reaches",
      "      READY (or FAILED). Ctrl-C is safe: finalize keeps running, re-attach with `wait`.",
