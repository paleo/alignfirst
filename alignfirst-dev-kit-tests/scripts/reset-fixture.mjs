...
const PRIMARY_MARKER = {
  description:
    "Managed projects of the AlignFirst Dev Kit test fixture. Adding a project is an operator's decision: ask before creating one.",
...
function patchFixture(dst, name, basePort) {
  ...
  pkg.name = `@alignfirst-dev-kit-tests/${name}-fixture`;
