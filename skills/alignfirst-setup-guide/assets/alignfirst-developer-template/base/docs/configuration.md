...
- `infra/openclaw/heartbeat-scratch.md` — the heartbeat job's checklist, pushed with `openclaw cron scratch` ([04 § 7](installations/04-openclaw.md#heartbeat-scratch)).
