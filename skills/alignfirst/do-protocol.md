...
- **Delegate to subagents** when the work is complex and involves:
...
Update the summary file during implementation if there is something significant to report. This provides real-time visibility and crash resilience.
