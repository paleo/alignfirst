...
## On every user message: read the playbook first

Before any reply text, before any other tool call, your first action must be a file read of the playbook for your surface:
